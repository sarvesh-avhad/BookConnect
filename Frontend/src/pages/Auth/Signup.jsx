        ...
        <div className="w-full md:w-1/2 bg-[#EBE2D4] p-6 lg:p-12 flex flex-col justify-center items-center relative">
          ...
          <div className="bg-[#F7F3E8] rounded-2xl border border-black p-8 sm:p-10 w-full max-w-[450px]">
            ...
            <div className="text-center mb-8">
              <h2 className="text-3xl font-serif text-[#111] mb-2 tracking-tight">Create Account</h2>
              <p className="text-sm text-gray-600 font-medium tracking-wide">Sign up to begin your reading journey</p>
            </div>

            <form onSubmit={handleSubmit} className="text-left space-y-4">

              <div>
                <label className="block text-xs font-bold text-[#111] mb-2 tracking-wide">Full Name</label>
              ...
              <div>
                <label className="block text-xs font-bold text-[#111] mb-2 tracking-wide">Email Address</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <UserIcon />
                  </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#E58500] hover:bg-[#D97900] text-[#111] border border-black font-bold py-3 rounded-lg shadow-[3px_3px_0px_#000] active:shadow-[0px_0px_0px_#000] active:translate-y-[3px] active:translate-x-[3px] transition-all tracking-wider text-[0.9rem] mt-5"
              >
                SIGN UP
              </button>
            ...
            <p className="text-[0.7rem] font-bold text-[#111] text-center mt-4">
              Already have an account? <Link to="/login" className="text-[#D96B00] hover:text-[#111] transition-colors ml-1">Login</Link>
            </p>
